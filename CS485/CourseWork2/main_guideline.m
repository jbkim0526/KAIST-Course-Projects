...
[data_train, data_test,test_img_idx, numBins] = getData('Caltech');
...
xlabel('Values');
ylabel('Frequency');
%pic_name = sprintf('./experiments/q1/%d_train_histogram.png', numBins);
%pic_name = sprintf('./experiments/q2/weak_train_histogram_%d_%d_%d.png', param.num, param.depth, param.splitNum);
%saveas(gcf, pic_name);
...
%pic_name = sprintf('./experiments/q1/%d_test_histogram.png', numBins);
%pic_name = sprintf('./experiments/q2/weak_test_histogram_%d_%d_%d.png', param.num, param.depth, param.splitNum);
%saveas(gcf, pic_name);
